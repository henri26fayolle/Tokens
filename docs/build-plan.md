...
**Phase 1 is done.** Next: user dogfoods (real-phone signup, route real usage, watch Goodhart), then the pre-launch checklist (provider ToS legal review, trademark/domain + Japanese vocab check, email provider for verification/magic links), then Phase 2 (feed, kudos, waza).
